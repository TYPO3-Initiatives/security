...
use TYPO3\CMS\Security\AccessControl\Policy\AbstractPolicy;
use TYPO3\CMS\Security\AccessControl\Policy\Evaluation\DenyOverridesEvaluator;
use TYPO3\CMS\Security\AccessControl\Policy\Evaluation\FirstApplicableEvaluator;
use TYPO3\CMS\Security\AccessControl\Policy\Evaluation\HighestPriorityEvaluator;
use TYPO3\CMS\Security\AccessControl\Policy\Evaluation\PermitOverridesEvaluator;
use TYPO3\CMS\Security\AccessControl\Policy\Policy;
use TYPO3\CMS\Security\AccessControl\Policy\PolicyFactory;
